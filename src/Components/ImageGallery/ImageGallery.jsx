...
//   const initialIds = images.map((image) => image.id);
//   const maxId = Math.max(...initialIds, 0);
...
//         <FaImage size={32} />
//         <h3 className="mb-[83px] text-lg font-bold">Add Image</h3>
//       </div>
//     ),
//     isFeature: false,
//   };
...
//     const newImage = {
//       img: imageData, // Use the provided imageData, not the placeholder content
//       isFeature: false,
//     };
